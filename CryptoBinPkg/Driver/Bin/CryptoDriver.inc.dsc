...
# DO NOT MODIFY
# GENERATED ON: 2025-03-06 10:36:19.098846
...
!if $(PEI_CRYPTO_SERVICES) == TINY_SHA
 ...
 !if $(PEI_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_TINY_SHA_Pei_$(TARGET)_ARM.inf 
 !endif
...
!if $(DXE_CRYPTO_SERVICES) == TINY_SHA
 ...
 !if $(DXE_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_TINY_SHA_Dxe_$(TARGET)_ARM.inf 
 !endif
...
!if $(RUNTIMEDXE_CRYPTO_SERVICES) == TINY_SHA
 ...
 !endif
 !if $(RUNTIMEDXE_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_TINY_SHA_RuntimeDxe_$(TARGET)_ARM.inf 
 !endif
...
!if $(PEI_CRYPTO_SERVICES) == MINIMAL_SHA_SM3
 ...
 !if $(PEI_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_MINIMAL_SHA_SM3_Pei_$(TARGET)_ARM.inf 
 !endif
...
!if $(DXE_CRYPTO_SERVICES) == MINIMAL_SHA_SM3
 ...
 !if $(DXE_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_MINIMAL_SHA_SM3_Dxe_$(TARGET)_ARM.inf 
 !endif
...
!if $(RUNTIMEDXE_CRYPTO_SERVICES) == MINIMAL_SHA_SM3
 ...
 !if $(RUNTIMEDXE_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_MINIMAL_SHA_SM3_RuntimeDxe_$(TARGET)_ARM.inf 
 !endif
...
!if $(PEI_CRYPTO_SERVICES) == SMALL_SHA_RSA
 ...
 !if $(PEI_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_SMALL_SHA_RSA_Pei_$(TARGET)_ARM.inf 
 !endif
...
!if $(DXE_CRYPTO_SERVICES) == SMALL_SHA_RSA
 ...
 !if $(DXE_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_SMALL_SHA_RSA_Dxe_$(TARGET)_ARM.inf 
 !endif
...
!if $(RUNTIMEDXE_CRYPTO_SERVICES) == SMALL_SHA_RSA
 ...
 !if $(RUNTIMEDXE_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_SMALL_SHA_RSA_RuntimeDxe_$(TARGET)_ARM.inf 
 !endif
...
!if $(PEI_CRYPTO_SERVICES) == STANDARD
 ...
 !if $(PEI_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_STANDARD_Pei_$(TARGET)_ARM.inf 
 !endif
...
!if $(DXE_CRYPTO_SERVICES) == STANDARD
 ...
 !if $(DXE_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_STANDARD_Dxe_$(TARGET)_ARM.inf 
 !endif
...
!if $(RUNTIMEDXE_CRYPTO_SERVICES) == STANDARD
 ...
 !if $(RUNTIMEDXE_CRYPTO_ARCH) == ARM
  [Components.ARM]
    $(SHARED_CRYPTO_PATH)/Driver/Bin/CryptoDriverBin_STANDARD_RuntimeDxe_$(TARGET)_ARM.inf 
 !endif
